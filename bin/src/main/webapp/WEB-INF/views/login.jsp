...
nav>ul>li.subscribe a {
	...
	padding-left: 33px;
	text-align: left;
	background: url("resoruces/img/rss.png") left center no-repeat;
}
...
<body>
	...
	<div class="container">
		...
		<div class="div_box">
			<form action="dologin.member" method="post" class="text-center form-signin">
				<img class="mb-4" src="/docs/4.3/assets/brand/bootstrap-solid.svg"
					alt="" width="72" height="72"> <label for="inputEmail"
					class="sr-only">ID</label> <input type="text" name="id" id="inputEmail"
				...
				<a href="detailLogin.html"><button class="btn btn-lg btn-primary btn-block" type="submit">Sign
					in</button></a>
			</form>
			<form class="text-center form-signin">
				<div class="btn-group" role="group" aria-label="Basic example">
					...
					<a href="#"><button type="button" class="btn btn-secondary btn-primary">guest 자동로그인</button></a>
